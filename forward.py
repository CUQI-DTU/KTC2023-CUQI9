...
matdict_true = sp.io.loadmat(
    "data/GroundTruths/true1.mat", struct_as_record=False, squeeze_me=True
)
matdict_ref = sp.io.loadmat(
    "data/TrainingData/ref.mat", struct_as_record=False, squeeze_me=True
)
